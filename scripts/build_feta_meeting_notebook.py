...
def main() -> None:
    ...
    notebook["cells"] = [
        nbf.v4.new_markdown_cell(
            ...
            "This local meeting notebook uses FeTA 2.2 SVR images and automatic FetalSynthSeg predictions, not synthetic "
        ...
        nbf.v4.new_markdown_cell("## Automatic segmentations in standard orientation"),
        ...
        nbf.v4.new_markdown_cell(
            ...
            "2. Run the frozen FetalSynthSeg model and measure its seven predicted-label volumes plus total brain and intracranial volume using "
            ...
            "The exact included count and age range are recorded in the generated metadata.\n"
